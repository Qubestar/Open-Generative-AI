...
export const PROVIDERS = [
  ...
  },
  {
    ...
    color: '#22c55e',
    icon: 'agnes',
    description: 'Multimodal AI gateway — text, image (Agnes Image Flash), video (Agnes Video). OpenAI-compatible chat completions.',
    docsUrl: 'https://wiki.agnes-ai.com/en/docs/quickstart',
    endpoints: {
      chat: '/chat/completions',
      image: '/images/generations',
      video: '/videos',
